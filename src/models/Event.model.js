...
const EventSchema = new mongoose.Schema({
    ...
    event: {
        type: String,
        enum: ["visit", "send_otp", "login_success", "location_selected", "location_popup", "address_selected", "product_viewed", "add_to_cart", "begin_checkout", "remove_from_cart", "add_payment_info", "conversion"],
        required: true
    },
    url: { type: String },
    platform: {
